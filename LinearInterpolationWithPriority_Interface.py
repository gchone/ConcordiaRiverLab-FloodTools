...
import arcpy
from LinearInterpolationWithPriority import *
...
class LinearInterpolation(object):
    def __init__(self):
        ...
        self.label = "Interpolation lineaire, avec priorisation aux confluences"
        self.description = "Interpolation linéaire suivant l'écoulement, avec priorisation aux confluences"
    ...
    def execute(self, parameters, messages):
        ...
        execute_LinearInterpolationWithPriority(arcpy.Raster(str_flowdir), str_frompoint, arcpy.Raster(str_values), SaveResult, messages)
