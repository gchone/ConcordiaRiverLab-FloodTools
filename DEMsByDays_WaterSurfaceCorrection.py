...
def execute_WaterSurfaceCorrection(correctedDEMs_dir, channel_poly_dir, polycuts, river_network, output_folder, messages):
    ...
    for raster in rasterlist:
        channelpoly = os.path.join(channel_poly_dir, raster+".shp")
...
if __name__ == "__main__":
    ...
    execute_WaterSurfaceCorrection(correctedDEMs_dir, channel_poly_dir, polycuts, river_network, output_folder, messages)
